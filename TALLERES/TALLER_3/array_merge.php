...
$misComidas = ["Pizza", "Hamburguesa", "Helado"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["Sushi", "Pollo frito", "Cheesecake"]; // Reemplaza con las comidas favoritas de tu amigo
