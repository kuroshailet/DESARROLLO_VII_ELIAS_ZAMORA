...
$miFrase = "Para aprender PHP, tengo que programar con PHP, por suerte me gusta PHP."; // Reemplaza esto con tu frase
...
$texto = "Las manzanas y naranjas son frutas al igual que el tomate. Me gustan las manzanas y las naranjas, pero no el tomate.";
$buscar = ["manzanas", "naranjas", "tomate"];
$reemplazar = ["peras", "uvas", "kiwi"];
