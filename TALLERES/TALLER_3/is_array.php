...
$miArray = ["Rojo","Azul","Naranja"]; // Reemplaza esto con tu propio array
$miString = "La calle es una selva de cemento."; // Reemplaza esto con tu propio string
$miNumero = 37; // Reemplaza esto con tu propio número
