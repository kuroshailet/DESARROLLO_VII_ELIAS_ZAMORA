...
$misAmigos = ["Jean Carlos", "Justin", "Dayron"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Oscar", "Ricardo"); // Reemplaza las comillas vacías con los nombres de tus amigos
